...
export function ContactUs() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = fetch("http://localhost:3001/api/form/contact", {
        method: "POST",
            ...
            <div className="flex items-center justify-center">
              <div className="px-2 md:px-12">
                ...
                <form className="mt-8 space-y-4">
                  ...
                  <button
                    type="button"
                    className="hover:bg-[#E6FF55] hover:text-green-950 w-full rounded-md bg-black px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-black/80 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-black"
