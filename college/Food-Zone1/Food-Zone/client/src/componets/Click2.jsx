...
const Click1 = () => {
  return (
    ...
    <div className=" ">
      ...
      <div className="bg-cover sm:bg-cover  text-wrap   h-screen  bg-[url(./assets/Blog_2.jpg)]   flex items-end bg-gray-600  mb-5 md:-mt-[180px] ">
        <div className="w-full text-center flex-col space-y-5 mb-5 ">
          ...
          <h1 className='text-2xl sm:text-4xl md:text-4xl lg:text-5xl font-bold text-white '>9 Things to Offer to Attract All Restaurant <br /> Positions</h1>
