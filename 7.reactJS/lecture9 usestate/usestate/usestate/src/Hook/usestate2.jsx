        ...
        <div>
            ...
            <div className="container flex-col justify-center items-center w-full ">
                ...
                <div className="flex justify-center items-center">
                    <button onClick={() => setcount(count + 1)} className='bg-gray-400 p-1 text-lg font-bold mx-1'>Increment</button>
                    <button onClick={() => count > 0 ? setcount(count - 1) : count} className='bg-gray-400 p-1 text-lg font-bold'>Decrement</button>
                </div>
            </div>
        </div>
    )
